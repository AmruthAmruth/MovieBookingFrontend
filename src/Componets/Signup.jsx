...
import { userSignup } from '../Api-Helpers/Api-helpers'
...
const handelSubmit=(e)=>{
    e.preventDefault()
             userSignup(name,phone,email,password).then((result)=>{
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div>
                  ...
                  <button onClick={handelSubmit} type="submit" class="w-full text-white bg-primary-600 hover:bg-primary-700 bg-gray-400 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create an account</button>
